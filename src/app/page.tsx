...
export default function Home() {
  ...
  const [noms, setNoms] = useState(['Thibauld', 'Eliott', 'Elsa', 'Damien', 'Bastien']);
  ...
  const [couleurChoisi, setCouleurChoisi] = useState('red');
  ...
  return (
      <div className={`flex justify-center items-center h-screen w-screen bg-[${couleurChoisi}]`} onClick={choisirNouveauNom}>
